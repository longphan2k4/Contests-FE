...
const QRCodeDisplay: React.FC<QRCodeDisplayProps> = ({
  ...
  const [timerLeft, setTimerLeft] = React.useState<number>(0);

  React.useEffect(() => {
    if (socket) {
      socket.on("timerLeft:Rescue", (data: any) => {
        if (data.match === matchSlug) {
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-200">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-blue-700 font-bold text-lg text-right flex-1 truncate">
                      {matchName}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-blue-700 font-bold text-lg text-right flex-1">
                      {currentQuestionOrder}
                    </span>
                  </div>
