...
const QuestionInfo: React.FC<QuestionInfoProps> = ({
  ...
  return (
    <div className="flex flex-wrap gap-2 my-4 justify-center text-lg">
      {/* quy: kích thước chữ */}
      <div className="text-xl px-4 py-2 bg-gray-200 rounded-full font-semibold">
        <QuestionMarkCircleIcon className="w-5 h-5 inline-block mr-2" />
        Câu {questionNumber}
      </div>
      <div className="text-xl px-4 py-2 bg-blue-600 text-white rounded-full font-semibold">
        {phase}
      </div>
      <div className="text-xl px-4 py-2 bg-gray-200 rounded-full font-semibold">
