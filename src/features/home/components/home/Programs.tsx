  ...
  const programs: ProgramItem[] = [
    {
      ...
      duration: "3 năm",
      description: "Đào tạo chuyên gia phát triển ứng dụng web và mobile",
    ...
    },
    {
      ...
      name: "Quản trị mạng",
      duration: "3 năm", 
      description: "Quản trị và phát triển hệ thống mạng",
    ...
    {
      id: 4,
      name: "Sữa chữa máy tính",
      duration: "3 năm",
      description: "Sửa chữa, bảo trì và nâng cấp thiết bị máy tính",
          ...
          {programs.map((program) => (
            <div key={program.id} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 group hover:-translate-y-2">
              ...
              <button className="text-blue-600 font-semibold hover:text-blue-800 transition-colors flex items-center">
                <a href='https://cntt.caothang.edu.vn'>Tìm hiểu thêm <ArrowRightIcon className="ml-2 w-4 h-4" /></a>
              </button>
            </div>
          ))}
        </div>
